...
DROP TABLE IF EXISTS GRUPO_PERIODO;
...
(
	...
	REFERENCES PROGRAMA_PERIODO (ID_CARRERA),
...
(
	...
	REFERENCES PROGRAMA_PERIODO (CODIGO_PERIODO),
	FOREIGN KEY (ID_PROFESOR)
	REFERENCES PROFESOR (ID),
	UNIQUE (CODIGO, GRUPO, ID_CARRERA, CODIGO_PERIODO)
);
